...
UPDATE `cdo_external_refs` SET `uri` = "http://b2international.com/snowowl/snomed/refset/1.0#//SnomedConcreteDataTypeRefSetMember/group" WHERE `id` = -88;
UPDATE `cdo_external_refs` SET `uri` = "http://b2international.com/snowowl/snomed/refset/1.0#//SnomedConcreteDataTypeRefSetMember/typeId" WHERE `id` = -89;

DELETE FROM `cdo_external_refs` WHERE `uri`="http://b2international.com/snowowl/snomed/mrcm#//ConcreteDomainElementPredicate/name";

UPDATE `cdo_external_refs` SET `uri` = "http://b2international.com/snowowl/snomed/mrcm#//ConcreteDomainElementPredicate/attribute" WHERE `id` = -136;
UPDATE `cdo_external_refs` SET `uri` = "http://b2international.com/snowowl/snomed/mrcm#//ConcreteDomainElementPredicate/range" WHERE `id` = -137;
