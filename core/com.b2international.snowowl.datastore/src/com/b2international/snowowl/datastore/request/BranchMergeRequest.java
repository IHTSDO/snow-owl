...
public final class BranchMergeRequest extends AbstractBranchChangeRequest<Merge> {
	...
	BranchMergeRequest(UUID id, final String sourcePath, final String targetPath, final String userId, final String commitMessage, String reviewId, String parentLockContext) {
